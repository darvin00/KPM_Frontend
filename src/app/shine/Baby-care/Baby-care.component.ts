...
export class BabyCareComponent implements OnInit {
  loading = true;
  fallbackImage: string = 'assets/images/shine/baby care/BABYPRODUCTS.jpg';
  products: any[] = [];
  animationMessages: { [key: number]: string } = {}; // Messages for animation
  ...
  buyNow(product: any): void {
    ...
    this.router.navigate(['/shine/shineview'], {
      ...
      // Store the productId in localStorage
    });
  }
